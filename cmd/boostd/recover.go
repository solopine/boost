...
import (
	...
	saccessor "github.com/filecoin-project/boost/lib/sa"
...
func action(cctx *cli.Context) error {
	...
	if ignoreLID {
		...
		pd = piecedirectory.NewPieceDirectory(cl, pr, nil, nil, cctx.Int("add-index-throttle"), piecedirectory.WithAddIndexConcurrency(cctx.Int("add-index-concurrency")))
		pd.Start(ctx)
	}
